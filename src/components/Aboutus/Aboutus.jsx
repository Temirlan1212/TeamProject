        ...
        <div className={classes.partSecond}>
          ...
          <div>
            <div className={classes.partSecondDesc}>
              ...
              включает в себя конверты, комплекты и одежда на выписку из роддома
              (с учётом времени года и различного фасона), одежда для
              новорожденных, комплекты детского постельного белья, пледы, а
              также бортики в кроватку. Вся изготовленная нами продукция
              выполнена только из натуральных тканей в нежной пастельной гамме
              оттенков, украшена изысканным декором в виде кружев и лент, с
              учётом сезона, а также сертифицирована и соответствует всем
